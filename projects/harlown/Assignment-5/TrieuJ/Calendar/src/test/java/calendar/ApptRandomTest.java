...
public class ApptRandomTest {
   ...
   /**
	...
	//			System.out.println(" Seed:"+randomseed );
				Random random = new Random(randomseed);
				 int startHour=ValuesGenerator.getRandomIntBetween(random, -5, 31);
				 int startMinute=ValuesGenerator.RandInt(random);
				 int startDay=ValuesGenerator.RandInt(random);
				 int startMonth=ValuesGenerator.getRandomIntBetween(random, 1, 11);
				 int startYear=ValuesGenerator.RandInt(random);
...
@Test
	...
	//			System.out.println(" Seed:"+randomseed );
				Random random = new Random(randomseed);
				 int startHour=ValuesGenerator.RandInt(random);
				 int startMinute=ValuesGenerator.RandInt(random);
				 int startDay=ValuesGenerator.getRandomIntBetween(random, -12, 40);
				 int startMonth=ValuesGenerator.getRandomIntBetween(random, 1, 11);
				 int startYear=ValuesGenerator.RandInt(random);
				 String title="Birthday Party";
				 String description="This is my birthday party.";
				 ...
				 Appt appt = new Appt(startHour,
				          ...
				          title,
				         description);
				 appt.setStartHour(ValuesGenerator.getRandomIntBetween(random, -12, 40));
			// if(!appt.getValid())continue;
			for (int i = 0; i < NUM_TESTS; i++) {
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   if (methodName.equals("setTitle")){
	...
	// 			          title,
	// 			         description);
	// 			 appt.setStartMonth(ValuesGenerator.getRandomIntBetween(random, -12, 40));
	// 		// if(!appt.getValid())continue;
	// 		for (int i = 0; i < NUM_TESTS; i++) {
	// 				String methodName = ApptRandomTest.RandomSelectMethod(random);
	// 				   if (methodName.equals("setTitle")){
